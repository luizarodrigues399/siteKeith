...
$post_layout_allow = array_keys(ube_get_post_masonry_layout());
$post_layout = isset($settings['post_layout']) ? $settings['post_layout'] : 'post-masonry-layout-01';
if (!in_array($post_layout,$post_layout_allow)) {
    $post_layout = 'post-masonry-layout-01';
}
