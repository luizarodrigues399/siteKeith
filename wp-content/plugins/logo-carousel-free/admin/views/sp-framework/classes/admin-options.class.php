	...
	class SPLC_FREE_Options extends SPLC_FREE_Abstract {
		...
		public function add_options_html() {
			...
			if ( $show_buttons ) {
				...
				echo '<input type="submit" name="' . esc_attr( $this->unique ) . '[_nonce][save]" class="button button-primary splogocarousel-top-save splogocarousel-save' . esc_attr( $ajax_class ) . '" value="' . esc_html__( 'Save Settings', 'logo-carousel-free' ) . '" data-save="' . esc_html__( 'Saving...', 'logo-carousel-free' ) . '">';
				echo ( $this->args['show_reset_section'] ) ? '<input type="submit" name="splogocarousel_transient[reset_section]" class="button button-secondary splogocarousel-reset-section splogocarousel-confirm" value="' . esc_html__( 'Reset Tab', 'logo-carousel-free' ) . '" data-confirm="' . esc_html__( 'Are you sure to reset all the settings of this tab?', 'logo-carousel-free' ) . '">' : '';
